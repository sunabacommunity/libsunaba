...
func _enter_tree() -> void:
	if instance != null:
		if instance.has_function("onEnterTree"):
			instance.call_function("onEnterTree", [])

func _exit_tree() -> void:
	if instance != null:
		if instance.has_function("onExitTree"):
			instance.call_function("onExitTree", [])

func _ready() -> void:
	if instance != null:
		if instance.has_function("onReady"):
			instance.call_function("onReady", [])

func _process(delta: float) -> void:
	if instance != null:
		if instance.has_function("onProcess"):
			instance.call_function("onProcess", [delta])

func _physics_process(delta: float) -> void:
	if instance != null:
		if instance.has_function("onPhysicsProcess"):
			instance.call_function("onPhysicsProcess", [delta])

func _input(event: InputEvent) -> void:
	if instance != null:
		if instance.has_function("_onInput"):
			instance.call_function("_onInput", [event])

func _unhandled_input(event: InputEvent) -> void:
	if instance != null:
		if instance.has_function("_onUnhandledInput"):
			instance.call_function("_onUnhandledInput", [event])

func _unhandled_key_input(event: InputEvent) -> void:
	if instance != null:
		if instance.has_function("_onUnhandledKeyInput"):
			instance.call_function("_onUnhandledKeyInput", [event])

func _shortcut_input(event: InputEvent) -> void:
	if instance != null:
		if instance.has_function("_onShortcutInput"):
			instance.call_function("_onShortcutInput", [event])
