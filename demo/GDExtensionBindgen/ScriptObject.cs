...
public class ScriptObject
{
	...
	public ScriptObject() : this(NativeName)
	{
	}
	protected ScriptObject(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected ScriptObject(Variant variant) : this((RefCounted) variant)
	{
	}
	protected ScriptObject([NotNull] RefCounted @object)
	{
		_object = @object;
	}

	public static implicit operator RefCounted(ScriptObject self) => self?._object;
	public static implicit operator Variant(ScriptObject self) => self?._object;
	public static explicit operator ScriptObject(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	public class MethodName : RefCounted.MethodName
	{
		...
		public static readonly StringName SetVar = "set_var";
		public static readonly StringName HasVar = "has_var";
		public static readonly StringName HasFunction = "has_function";
		public static readonly StringName CallFunction = "call_function";
	}
	...
	private static readonly StringName NativeName = "ScriptObject";

	#region Methods

	public Variant GetVar(string @name)
	{
		return (Variant)_object.Call(MethodName.GetVar, @name);
	}

	public void SetVar(string @name, Variant @variant)
	{
		_object.Call(MethodName.SetVar, @name, @variant);
	}

	public bool HasVar(string @name)
	{
		return (bool)_object.Call(MethodName.HasVar, @name);
	}

	public bool HasFunction(string @name)
	{
		return (bool)_object.Call(MethodName.HasFunction, @name);
	}

	public Variant CallFunction(string @name, Godot.Collections.Array @args)
	{
		return (Variant)_object.Call(MethodName.CallFunction, @name, @args);
	}
