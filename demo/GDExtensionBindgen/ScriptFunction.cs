...
public class ScriptFunction
{
	...
	public ScriptFunction() : this(NativeName)
	{
	}
	protected ScriptFunction(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected ScriptFunction(Variant variant) : this((RefCounted) variant)
	{
	}
	protected ScriptFunction([NotNull] RefCounted @object)
	{
		_object = @object;
	}

	public static implicit operator RefCounted(ScriptFunction self) => self?._object;
	public static implicit operator Variant(ScriptFunction self) => self?._object;
	public static explicit operator ScriptFunction(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	{
		public static readonly StringName CallFunc = "call_func";
	}
	...
	private static readonly StringName NativeName = "ScriptFunction";

	#region Methods

	public Variant CallFunc(Godot.Collections.Array @args)
	{
		return (Variant)_object.Call(MethodName.CallFunc, @args);
	}
