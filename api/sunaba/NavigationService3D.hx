...
class NavigationService3D extends BaseClass {
  ...
  public function agentGetHeight(agent: Int): Float {
      var args = new ArrayList();
      args.append(agent);
  ...
  public function agentGetPosition(agent: Int): Vector3 {
      var args = new ArrayList();
      args.append(agent);
  ...
  public function agentGetUse3dAvoidance(agent: Int): Bool {
      var args = new ArrayList();
      args.append(agent);
      return getNative().call('agent_get_use_3d_avoidance', args);
  }
  public function agentGetVelocity(agent: Int): Vector3 {
      var args = new ArrayList();
      args.append(agent);
  ...
  public function agentSetHeight(agent: Int, height: Float): Void {
      var args = new ArrayList();
      args.append(agent);
      args.append(height);
  ...
  public function agentSetPosition(agent: Int, position: Vector3): Void {
      var args = new ArrayList();
      args.append(agent);
  ...
  public function agentSetUse3dAvoidance(agent: Int, enabled: Bool): Void {
      var args = new ArrayList();
      args.append(agent);
      args.append(enabled);
      getNative().call('agent_set_use_3d_avoidance', args);
  }
  public function agentSetVelocity(agent: Int, velocity: Vector3): Void {
      var args = new ArrayList();
      args.append(agent);
      args.append(velocity);
      getNative().call('agent_set_velocity', args);
  }
  public function agentSetVelocityForced(agent: Int, velocity: Vector3): Void {
      var args = new ArrayList();
      args.append(agent);
      args.append(velocity);
  ...
  public function linkGetEndPosition(link: Int): Vector3 {
      var args = new ArrayList();
      args.append(link);
  ...
  public function linkGetStartPosition(link: Int): Vector3 {
      var args = new ArrayList();
      args.append(link);
  ...
  public function linkSetEndPosition(link: Int, position: Vector3): Void {
      var args = new ArrayList();
      args.append(link);
      args.append(position);
  ...
  public function linkSetStartPosition(link: Int, position: Vector3): Void {
      var args = new ArrayList();
      args.append(link);
      args.append(position);
  ...
  public function mapGetCellHeight(map: Int): Float {
      var args = new ArrayList();
      args.append(map);
  ...
  public function mapGetClosestPoint(map: Int, toPoint: Vector3): Vector3 {
      var args = new ArrayList();
      args.append(map);
      args.append(toPoint);
      return getNative().call('map_get_closest_point', args);
  }
  public function mapGetClosestPointNormal(map: Int, toPoint: Vector3): Vector3 {
      var args = new ArrayList();
      args.append(map);
      args.append(toPoint);
      return getNative().call('map_get_closest_point_normal', args);
  }
  public function mapGetClosestPointOwner(map: Int, toPoint: Vector3): Int {
      var args = new ArrayList();
      args.append(map);
      args.append(toPoint);
      return getNative().call('map_get_closest_point_owner', args);
  }
  public function mapGetClosestPointToSegment(map: Int, start: Vector3, end: Vector3, ?useCollision: Bool): Vector3 {
      var args = new ArrayList();
      args.append(map);
      args.append(start);
      args.append(end);
  ...
  public function mapGetPath(map: Int, origin: Vector3, destination: Vector3, optimize: Bool, ?navigationLayers: Int): TypedArray<Vector3> {
      var args = new ArrayList();
      args.append(map);
      args.append(origin);
  ...
  public function mapGetRandomPoint(map: Int, navigationLayers: Int, uniformly: Bool): Vector3 {
      var args = new ArrayList();
      args.append(map);
      args.append(navigationLayers);
  ...
  public function mapGetUp(map: Int): Vector3 {
      var args = new ArrayList();
      args.append(map);
  ...
  public function mapSetCellHeight(map: Int, cellHeight: Float): Void {
      var args = new ArrayList();
      args.append(map);
  ...
  public function mapSetUp(map: Int, up: Vector3): Void {
      var args = new ArrayList();
      args.append(map);
      args.append(up);
  ...
  public function obstacleGetHeight(obstacle: Int): Float {
      var args = new ArrayList();
      args.append(obstacle);
  ...
  public function obstacleGetPosition(obstacle: Int): Vector3 {
      var args = new ArrayList();
      args.append(obstacle);
  ...
  public function obstacleGetUse3dAvoidance(obstacle: Int): Bool {
      var args = new ArrayList();
      args.append(obstacle);
      return getNative().call('obstacle_get_use_3d_avoidance', args);
  }
  public function obstacleGetVelocity(obstacle: Int): Vector3 {
      var args = new ArrayList();
      args.append(obstacle);
      return getNative().call('obstacle_get_velocity', args);
  }
  public function obstacleGetVertices(obstacle: Int): TypedArray<Vector3> {
      var args = new ArrayList();
      args.append(obstacle);
  ...
  public function obstacleSetHeight(obstacle: Int, height: Float): Void {
      var args = new ArrayList();
      args.append(obstacle);
      args.append(height);
  ...
  public function obstacleSetPosition(obstacle: Int, position: Vector3): Void {
      var args = new ArrayList();
      args.append(obstacle);
      args.append(position);
  ...
  public function obstacleSetUse3dAvoidance(obstacle: Int, enabled: Bool): Void {
      var args = new ArrayList();
      args.append(obstacle);
      args.append(enabled);
      getNative().call('obstacle_set_use_3d_avoidance', args);
  }
  public function obstacleSetVelocity(obstacle: Int, velocity: Vector3): Void {
      var args = new ArrayList();
      args.append(obstacle);
      args.append(velocity);
      getNative().call('obstacle_set_velocity', args);
  }
  public function obstacleSetVertices(obstacle: Int, vertices: TypedArray<Vector3>): Void {
      var args = new ArrayList();
      args.append(obstacle);
  ...
  public function regionGetClosestPoint(region: Int, toPoint: Vector3): Vector3 {
      var args = new ArrayList();
      args.append(region);
      args.append(toPoint);
      return getNative().call('region_get_closest_point', args);
  }
  public function regionGetClosestPointNormal(region: Int, toPoint: Vector3): Vector3 {
      var args = new ArrayList();
      args.append(region);
      args.append(toPoint);
      return getNative().call('region_get_closest_point_normal', args);
  }
  public function regionGetClosestPointToSegment(region: Int, start: Vector3, end: Vector3, ?useCollision: Bool): Vector3 {
      var args = new ArrayList();
      args.append(region);
      args.append(start);
      args.append(end);
  ...
  public function regionGetConnectionPathwayEnd(region: Int, connection: Int): Vector3 {
      var args = new ArrayList();
      args.append(region);
      args.append(connection);
      return getNative().call('region_get_connection_pathway_end', args);
  }
  public function regionGetConnectionPathwayStart(region: Int, connection: Int): Vector3 {
      var args = new ArrayList();
      args.append(region);
      args.append(connection);
  ...
  public function regionGetRandomPoint(region: Int, navigationLayers: Int, uniformly: Bool): Vector3 {
      var args = new ArrayList();
      args.append(region);
      args.append(navigationLayers);
      args.append(uniformly);
  ...
  public function regionOwnsPoint(region: Int, point: Vector3): Bool {
      var args = new ArrayList();
      args.append(region);
      args.append(point);
  ...
  public function regionSetNavigationMesh(region: Int, navigationMesh: Variant): Void {
      var args = new ArrayList();
      args.append(region);
      args.append(navigationMesh);
