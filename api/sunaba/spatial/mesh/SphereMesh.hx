...
class SphereMesh extends PrimitiveMesh {
    ...
    public var isHemisphere(get, set): Bool;
    function get_isHemisphere():Bool {
        return res.native.get("is_hemisphere");
    }
    function set_isHemisphere(value:Bool):Bool {
        res.native.set("is_hemisphere", value);
        return value;
    }
    ...
    public override function getData():Dictionary {
        ...
        data.set("isHemisphere", isHemisphere);
    ...
    public override function setData(data:Dictionary) {
        ...
        isHemisphere = data.get("isHemisphere");
    ...
    public override function onInit() {
        res = new Resource(new NativeReference("SphereMesh"));
        super.onInit();
    }
}